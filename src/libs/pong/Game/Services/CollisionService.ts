...
class CollidableService {
    private static instance: CollidableService;

    private collidables: Mesh[] = [];

    private constructor() {}

    static getInstance(): CollidableService {
        if (!CollidableService.instance) {
            CollidableService.instance = new CollidableService();
        }
        return CollidableService.instance;
    }
