...
export function MainLayout({ children }: { children: Element }) {
	return (
		<div className="bg-radial-primary flex h-full w-full items-center justify-center overflow-hidden p-4 md:p-8">
			<div className="chamfer relative z-0 flex h-full w-full bg-white p-[2px]">
				<div className="chamfer relative z-10 flex h-full w-full flex-col overflow-hidden">
