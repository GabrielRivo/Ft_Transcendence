...
ws://localhost:8080/api/chat/?EIO=4&transport=websocket

visiblement la connection ne fonctionne pas

@zsh (1006-1017) Aucun nouveau message

cote frontend je suis en offline@nginx/nginx.dev.conf 
