...
export function ButtonStyle2({ children, onClick, color = 'bg-transparent' }: ButtonStyle2Props) {
	...
	return (
		...
		>
			<div className="absolute top-0 right-0 size-2 border-t-2 border-r-2 border-white opacity-50"></div>
			<div className="absolute bottom-0 left-0 size-2 border-b-2 border-l-2 border-white opacity-50"></div>
