...
export function ChatSidebarPanel({
	...
	return (
		<div className="group shadow-neon-complex-sm-low hover:shadow-neon flex h-full min-h-0 flex-col overflow-hidden rounded-xl border border-cyan-500/40 bg-slate-950/60 shadow-cyan-500 backdrop-blur-md transition-all duration-300 hover:-translate-y-2 hover:border-cyan-400 hover:shadow-cyan-500">
